...
export const DEFAULT_CONFIG: ConfigurationData = {
  "standardMenus": [
    ...
    },
    {
      ...
      "spotterModelId": "4cbc6f2a-04f5-4efc-b3fb-2571cee855e4",
      "spotterSearchQuery": "What was the passenger traffic growth rate last month?"
    },
    {
      "id": "search",
      "name": "Search",
  ...
  "customMenus": [
    {
      ...
      "contentSelection": {
        ...
        "specificContent": {
          "liveboards": [
            "1f63b1d4-f138-4742-9369-39e6c116ba94"
          ],
          "answers": []
        }
      }
  ...
  "stylingConfig": {
    "application": {
      "topBar": {
        ...
        "logoUrl": "data:image/jpeg;base64,/9j/4AAQSkZJRgABAQAAAQABAAD..."
      },
      "sidebar": {
