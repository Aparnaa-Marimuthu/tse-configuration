  ...
  "stylingConfig": {
    "application": {
      ...
      "sidebar": {
        ...
        "foregroundColor": "rgba(51, 147, 24, 1.0)"
      },
      "footer": {
        "backgroundColor": "#ffffff",
        "foregroundColor": "#333333"
    ...
    "embeddedContent": {
      ...
      "customCSS": {
        "variables": {
          ...
          "--ts-var-button--secondary-background": "rgba(127, 0, 255, 1.0)",
          "--ts-var-button--secondary--hover-background": "rgba(127, 0, 255, 0.8)",
          "--ts-var-button--secondary--active-background": "rgba(127, 0, 255, 0.6)",
          "--ts-var-button--tertiary-background": "rgba(0, 100, 0, 1.0)",
          "--ts-var-button--tertiary--hover-background": "rgba(0, 100, 0, 0.8)",
          "--ts-var-button--tertiary--active-background": "rgba(0, 100, 0, 0.6)",
          "--ts-var-menu-background": "rgba(127, 0, 255, 1.0)",
          "--ts-var-menu--hover-background": "rgba(127, 0, 255, 0.8)",
